...
//   Future<void> _checkAuthentication(AuthCheckAuthenticationEvent event, Emitter<AuthState> emit) async {
//     emit(state.copyWith(status: AuthStateStatus.checkingAuthentication));

//     //TODO: Change this to use real API
//     final isAuthenticated = await authenticationRepository.isAuthenticated();

//     emit(state.copyWith(status: AuthStateStatus.checkedAuthentication));
